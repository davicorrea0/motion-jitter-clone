...
export default function LoopQA() {
  ...
  async function run() {
    ...
    const cases: [string,number,number,Record<string,any>][] = window.location.search.includes('proximity') ? [
      ['field-prox-05',1080,1920,{}],
      ['field-prox-05',3840,2160,{panRange:200,maxScale:200,tilt:45,sizeMix:100}],
    ] : spatial ? [
      ['ticker-02',1080,1920,{count:4,rows:2,outerFade:0}],
      ['ticker-02',3840,2160,{tilt:55,perspective:100,zoom:0,count:6,rows:2}],
    ] : [
      ['parallax-r01',1080,1920,{}],
      ['parallax-r03',3840,2160,{count:8,spread:20,travel:300}],
      ['field-prox-01',1080,1920,{}],
      ['field-prox-04',3840,2160,{count:100,panRange:200,offset:{x:300,y:-200}}],
      ['parallax-05',3840,2160,{offset:{x:300,y:600},speed:2}],
      ['field-02',3840,2160,{}],
      ['ticker-01',1080,1920,{count:2,outerFade:0}],
      ['ticker-02',3840,2160,{count:4,rows:2,outerFade:0}],
    ];
