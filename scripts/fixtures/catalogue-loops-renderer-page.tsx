...
export default function LoopQA() {
  ...
  async function run() {
    ...
    const cases: [string,number,number,Record<string,any>][] = spatial ? [
      ['ring-r01',1080,1920,{cycles:1.25}],
      ['globe-r01',1080,1920,{cycles:.25,cycleDeg:60}],
      ['globe-r02',1080,1920,{motion:'stepped',cycles:1.25}],
      ['carousel3d-01',3840,2160,{cycles:2.5,cycleDeg:60}],
    ] : [
      // Free-running Spiral's timeline policy remains pending; see audit report.
      ['scale-02',1080,1920,{}],
      ['scale-04',3840,2160,{}],
      ['scale-05',1080,1920,{fade:0}],
      ['scale-06',3840,2160,{count:3}],
      ['canvas-gallery-03',1080,1920,{}],
      ['canvas-gallery-02',3840,2160,{}],
    ];
